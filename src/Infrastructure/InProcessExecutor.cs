...
namespace BenchmarkDotNet.Toolchains.InProcess
{
	...
	/// </summary>
	public class InProcessExecutorOld : IExecutor
	{
		/// <summary>Initializes a new instance of the <see cref="InProcessExecutorOld"/> class.</summary>
		/// <param name="timeout">Timeout for the run.</param>
		/// <param name="logOutput"><c>true</c> if the output should be logged.</param>
		public InProcessExecutorOld(TimeSpan timeout, bool logOutput)
		{
